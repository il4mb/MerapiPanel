...
class Modal extends UnitModel {
    ...
    render() {
        ...
        modal.find('.modal-body').html("").append(this.#content as any);
    ...
    static from(target: HTMLElement | JQuery): ModalTypeInterface {
